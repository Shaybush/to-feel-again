...
export const HeroSection = () => {
  ...
  return (
    <main className="relative w-full text-white" dir="rtl">
      <div className="relative flex justify-end">
        <div className="relative w-[464px] h-[1400px]">
          <Image
            width={460}
            height={1600}
          ...
          <div className="absolute top-[800px] font-extralight">
          ...
          {/* Event section */}
          <div className="absolute w-full top-[1280px] font-extralight [direction:ltr]">
